...
var Human = function(name){
  ...
  this.birthday = function(num){
    this.age+=num;
    console.log("Congratulations "+this.name+"!!You are "+this.age+"now");
  };
};
...
/*
  Answer here:
When `blake` was created using the new keyword, it made a copy of all the properties and behaviours that were 
described in the constructor Human. Then blake's copy of talk method was overwritten when we wrote
blake.talk = function(){
  console.log("Hello, my name is Blake and I go to "+this.school+" school!")
}

While Ari is still using the version of talk() that it received from Human constructor
