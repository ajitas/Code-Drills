...
Because it has not been called yet
...
function goodDay()
{
    var userResponse = confirm("Are you having a good day?");
    log(userResponse);
}
...
function userPopUp()
{
    var userResponse = confirm("Would you like a popup?");
    if(userResponse){
        popUp();
    }
    else{
...
function favoriteFruit(){
    var favFruit = prompt("Enter your favorite food");
    alert(favFruit);
}
