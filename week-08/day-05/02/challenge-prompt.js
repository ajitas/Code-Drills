...
//
/* --------------- YOUR ANSWER HERE ---------------
O(1) constant time opeartion. Independent of input size
...
O(n^2). We have nested for loops here
...
O(n). beacuse we are going through the whole string once
...
//
/* --------------- YOUR ANSWER HERE ---------------
O(n) because we are looping through the for loop n times and inside the loop
