...
//
/* --------------- YOUR ANSWER HERE ---------------
It seems toLowerCase() will take O(n) time.
for loop runs n times but within for loop we have includes(),
which uses liner search according to what i read. so total complexity is O(n^2)
