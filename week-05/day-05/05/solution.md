...
##solution
answer: 1 step
1. take 1 coin from stack1, 2 coins from stack2, 3 from stacks...10 from stack 10
2. Convert the total weight shown in grams. If the last digit is 1, then the faulty stack is stack1, if the last digit is 2, the faulty stack is stack2...if the last digit is 0, the faulty stack is the stack10.